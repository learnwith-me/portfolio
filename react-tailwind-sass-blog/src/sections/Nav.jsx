        ...
        <header className="header-section dark:bg-darkModeBlack">
            <div className="header-wrap global-padding">
                <div className="header-logo">
                    <a href="index.html" className="is-logo dark:text-white">
                        Harshad Patil
                    </a>
                </div>
                    ...
                    <input id="toggle" className="header-checkbox" type="checkbox" />
                        ...
                        <nav className=' max-md:dark:!bg-white'>
                            <ul>
                                ...
                                <li onClick={openSearch} className="header-search search-open is-desktop global-button dark:bg-darkModeGray2 group"><span className='flex dark:text-white group-hover:dark:text-black'><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path className=' dark:fill-white group-hover:dark:fill-black' d="m16.822 18.813 4.798 4.799c.262.248.61.388.972.388.772-.001 1.407-.637 1.407-1.409 0-.361-.139-.709-.387-.971l-4.799-4.797c3.132-4.108 2.822-10.005-.928-13.756l-.007-.007-.278-.278a.6985.6985 0 0 0-.13-.107C13.36-1.017 7.021-.888 3.066 3.067c-4.088 4.089-4.088 10.729 0 14.816 3.752 3.752 9.65 4.063 13.756.93Zm-.965-13.719c2.95 2.953 2.95 7.81 0 10.763-2.953 2.949-7.809 2.949-10.762 0-2.951-2.953-2.951-7.81 0-10.763 2.953-2.95 7.809-2.95 10.762 0Z" /></svg>Search</span></li>
